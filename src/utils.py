...
def get_bboxes(
    ...
    """
    get predicted boxes from data loader
    """
    all_pred_boxes = []
    all_true_boxes = []
...
def save_checkpoint(state, filename="my_checkpoint.pth", output_dir='/output'):
    print("=> Saving checkpoint")
    torch.save(state, f"{output_dir}/{filename}")
